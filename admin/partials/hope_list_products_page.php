...
/**
 * Provide a admin area Product List  for the plugin
 *
 ...
 */
    ...
    global $wpdb;
    $table = new Custom_products_List_Table();
    $table->prepare_items();
    $message = '';
...
?>
    <div class="wrap">
        ...
        <h2><?php _e('Products', 'hope') ?> 
            <a class="add-new-h2" href="<?php echo get_admin_url(get_current_blog_id(), 'admin.php?page=product-new'); ?>"><?php _e('Add New Product', 'hope') ?></a>
         </h2>
